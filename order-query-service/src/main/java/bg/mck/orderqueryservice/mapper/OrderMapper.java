...
public interface OrderMapper {
    ...
    @Mapping(target = "lengthUnit", expression = "java(fastenerEntity.getLength() != null && fastenerEntity.getLength().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(fastenerEntity.getLength().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "maxLengthUnit", expression = "java(galvanisedSheetEntity.getMaxLength() != null && galvanisedSheetEntity.getMaxLength().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(galvanisedSheetEntity.getMaxLength().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    @Mapping(target = "quantity", expression = "java(galvanisedSheetEntity.getQuantity() != null ? galvanisedSheetEntity.getQuantity().split(\"\\\\s+\")[0] : null)")
    @Mapping(target = "quantityUnit", expression = "java(galvanisedSheetEntity.getQuantity() != null && galvanisedSheetEntity.getQuantity().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.AreaUnits.valueOf(galvanisedSheetEntity.getQuantity().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "thicknessUnit", expression = "java(insulationEntity.getThickness() != null && insulationEntity.getThickness().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(insulationEntity.getThickness().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    @Mapping(target = "quantity", expression = "java(insulationEntity.getQuantity() != null ? insulationEntity.getQuantity().split(\"\\\\s+\")[0] : null)")
    @Mapping(target = "quantityUnit", expression = "java(insulationEntity.getQuantity() != null && insulationEntity.getQuantity().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.AreaUnits.valueOf(insulationEntity.getQuantity().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "totalWeightUnit", expression = "java(metalEntity.getTotalWeight() != null && metalEntity.getTotalWeight().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.WeightUnits.valueOf(metalEntity.getTotalWeight().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "lengthUnit", expression = "java(panelEntity.getLength() != null && panelEntity.getLength().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(panelEntity.getLength().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    @Mapping(target = "width", expression = "java(panelEntity.getWidth() != null ? panelEntity.getWidth().split(\"\\\\s+\")[0] : null)")
    @Mapping(target = "widthUnit", expression = "java(panelEntity.getWidth() != null && panelEntity.getWidth().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(panelEntity.getWidth().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "totalThicknessUnit", expression = "java(panelEntity.getTotalThickness() != null && panelEntity.getTotalThickness().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(panelEntity.getTotalThickness().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "frontSheetThicknessUnit", expression = "java(panelEntity.getFrontSheetThickness() != null && panelEntity.getFrontSheetThickness().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(panelEntity.getFrontSheetThickness().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "backSheetThicknessUnit", expression = "java(panelEntity.getBackSheetThickness() != null && panelEntity.getBackSheetThickness().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(panelEntity.getBackSheetThickness().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    @Mapping(target = "quantity", expression = "java(panelEntity.getQuantity() != null ? panelEntity.getQuantity().split(\"\\\\s+\")[0] : null)")
    @Mapping(target = "quantityUnit", expression = "java(panelEntity.getQuantity() != null && panelEntity.getQuantity().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.AreaUnits.valueOf(panelEntity.getQuantity().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    ...
    @Mapping(target = "maxLengthUnit", expression = "java(rebarEntity.getMaxLength() != null && rebarEntity.getMaxLength().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.LengthUnits.valueOf(rebarEntity.getMaxLength().split(\"\\\\s+\")[1].toUpperCase()) : null)")
    @Mapping(target = "quantity", expression = "java(rebarEntity.getQuantity() != null ? rebarEntity.getQuantity().split(\"\\\\s+\")[0] : null)")
    @Mapping(target = "quantityUnit", expression = "java(rebarEntity.getQuantity() != null && rebarEntity.getQuantity().split(\"\\\\s+\").length > 1 ? bg.mck.orderqueryservice.entity.enums.WeightUnits.valueOf(rebarEntity.getQuantity().split(\"\\\\s+\")[1].toUpperCase()) : null)")
